...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference("Manager.count") do
      post managers_url, params: { manager: { construction_id: @manager.construction_id, user_id: @manager.user_id } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { construction_id: @manager.construction_id, user_id: @manager.user_id } }
